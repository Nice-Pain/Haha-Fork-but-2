...
class PlayState extends MusicBeatState
{
	...
	var detailsPausedText:String = "";
        ...
        //Block
        var bfBlocking:Bool = false;
	var bfCanBlock:Bool = false;
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'alley': //Part 1
				...
				var alleyBack:BGSprite = new BGSprite('whittyBack', -600, -300, 1, 1);
				alleyBack.setGraphicSize(Std.int(alleyBack.width * 1));
				alleyBack.updateHitbox();
				add(alleyBack);

				var alleyFront:BGSprite = new BGSprite('whittyFront', -650, 600, 1, 1);
				alleyFront.setGraphicSize(Std.int(alleyFront.width * 1));
				alleyFront.updateHitbox();
				add(alleyFront);
			}
